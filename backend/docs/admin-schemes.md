...
When a dead URL is triaged with one of those statuses, it stops counting as an actionable review flag in the admin queue. The note is stored with the review record for later reference.
